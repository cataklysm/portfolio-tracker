-- Development-only: seed fundamentals.refresh_interests so the fundamentals
-- refresh scheduler tracks every held instrument at startup.
--
-- In production these rows are built by the fundamentals service consuming
...
INSERT INTO fundamentals.refresh_interests
