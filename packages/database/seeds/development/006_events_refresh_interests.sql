-- Development-only: seed events.refresh_interests so the events refresh
-- scheduler tracks every held instrument at startup.
--
-- In production these rows are built by the events service consuming
...
INSERT INTO events.refresh_interests
