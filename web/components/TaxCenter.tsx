  ...
  return (
    <section className="app-panel overflow-hidden rounded-xl">
      ...
      <div className="grid sm:grid-cols-2 lg:grid-cols-4">
        ...
        <Metric label="Realized P&L after actual tax" value={signed(report.realized_pnl_after_actual_tax, locale, currency)} tone={tone(after)} sub={`Net tax ${money(report.net_actual_tax, locale, currency)}`} />
      </div>

      <p className="border-t border-[var(--app-border)] px-4 py-2 text-[10px] leading-4 text-[var(--app-text-faint)]">
        Recorded broker tax is information your broker booked — not a tax-liability calculation. A zero balance means
        nothing was recorded, never that no tax is owed. Gross figures are unchanged; after-tax subtracts net recorded tax.
      </p>
