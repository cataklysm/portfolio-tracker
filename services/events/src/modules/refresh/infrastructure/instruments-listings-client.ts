 ...
 * `/internal/listings/all`. Replaces the former watch-set hydration: the events
 * refresh now sweeps the whole catalog, not just held/watched instruments (the
 * events service's freshness gate still bounds actual fetches).
 *
